...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null,"Maria Silva", "deivi_gf144@hotmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("123456", "321654"));
		
		Cliente cli2 = new Cliente(null,"Ana Costa", "david.jeane@gmail.com", "21849707006", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("321654", "123457"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardins", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "38777001", cli2, c2);
